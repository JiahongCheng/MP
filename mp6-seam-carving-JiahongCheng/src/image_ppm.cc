...
void ImagePPM::NewHeight(Pixel** new_pixel, int height, int width) {
  Clear();
  pixels_ = new_pixel;
  height_ = height;
  width_ = width;
  max_color_value_ = GetMaxColorValue();
}
void ImagePPM::NewWidth(Pixel** new_pixel, int height, int width) {
  Clear();
  pixels_ = new_pixel;
  height_ = height;
  width_ = width;
